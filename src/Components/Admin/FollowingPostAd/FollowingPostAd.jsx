...
function FollowingPostAd() {
  ...
  const [clickedButton, setClickedButton] = useState("button2");
  ...
  useEffect(() => {
    Axios.get(baseUrl + "/api/see/post_following/" + userID).then(
      (response) => {
...
export default FollowingPostAd;
