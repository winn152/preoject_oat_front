...
import "./DetailsDelete2.css";
import { baseUrl } from "../../../baseUrl";
import Popup from "../EditPost/PopupEd"


const DetailsDelete2 = () => {
    ...
    <div className="b">
      ...
      <div className="containershowout">
            ...
            {seeComm.map((i) => {
              return (
                ...
                <div className="commentuser">
                  <img className="" src={i.img_pf} alt="Profile" />
                  <p>{i.text}</p>
                </div>
              );
            })}
        ...
        <div className="containershowout2">
          <button
            type="button"
            className="DetailsD-btnn"
            onClick={de_post} // Opens the modal
